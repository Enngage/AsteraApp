...
/***/ "../core/_commonjs/error-handling/cloud-error.js":
/*!*******************************************************!*\
  !*** ../core/_commonjs/error-handling/cloud-error.js ***!
  \*******************************************************/
...
/***/ "../core/_commonjs/error-handling/index.js":
/*!*************************************************!*\
  !*** ../core/_commonjs/error-handling/index.js ***!
  \*************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./cloud-error */ "../core/_commonjs/error-handling/cloud-error.js"));
__export(__webpack_require__(/*! ./map-cloud-error */ "../core/_commonjs/error-handling/map-cloud-error.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../core/_commonjs/error-handling/map-cloud-error.js":
/*!***********************************************************!*\
  !*** ../core/_commonjs/error-handling/map-cloud-error.js ***!
  \***********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var cloud_error_1 = __webpack_require__(/*! ./cloud-error */ "../core/_commonjs/error-handling/cloud-error.js");
var KCErrorNames = {
...
/***/ "../core/_commonjs/helpers/enum.helper.js":
/*!************************************************!*\
  !*** ../core/_commonjs/helpers/enum.helper.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/helpers/header.helper.js":
/*!**************************************************!*\
  !*** ../core/_commonjs/helpers/header.helper.js ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/helpers/index.js":
/*!******************************************!*\
  !*** ../core/_commonjs/helpers/index.js ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./url.helper */ "../core/_commonjs/helpers/url.helper.js"));
__export(__webpack_require__(/*! ./header.helper */ "../core/_commonjs/helpers/header.helper.js"));
__export(__webpack_require__(/*! ./enum.helper */ "../core/_commonjs/helpers/enum.helper.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../core/_commonjs/helpers/url.helper.js":
/*!***********************************************!*\
  !*** ../core/_commonjs/helpers/url.helper.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/http/http.debugger.js":
/*!***********************************************!*\
  !*** ../core/_commonjs/http/http.debugger.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/http/http.functions.js":
/*!************************************************!*\
  !*** ../core/_commonjs/http/http.functions.js ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var axios_1 = __webpack_require__(/*! axios */ "../core/node_modules/axios/index.js");
var http_debugger_1 = __webpack_require__(/*! ./http.debugger */ "../core/_commonjs/http/http.debugger.js");
function getCallback(call, options, callback) {
    http_debugger_1.httpDebugger.debugStartHttpRequest();
    var axiosPromise = axios_1.default.get(call.url, {
        headers: getHeadersJson(options && options.headers ? options.headers : [])
    });
...
function putCallback(call, options, callback) {
    http_debugger_1.httpDebugger.debugStartHttpRequest();
    var axiosPromise = axios_1.default.put(call.url, call.body, {
        headers: getHeadersJson(options && options.headers ? options.headers : [])
    });
    axiosPromise.then(function (response) {
        http_debugger_1.httpDebugger.debugResolveHttpRequest();
...
function deleteCallback(call, options, callback) {
    http_debugger_1.httpDebugger.debugStartHttpRequest();
    var axiosPromise = axios_1.default.delete(call.url, {
        headers: getHeadersJson(options && options.headers ? options.headers : [])
    });
    axiosPromise.then(function (response) {
        http_debugger_1.httpDebugger.debugResolveHttpRequest();
...
function postCallback(call, options, callback) {
    http_debugger_1.httpDebugger.debugStartHttpRequest();
    var axiosPromise = axios_1.default.post(call.url, call.body, {
        headers: getHeadersJson(options && options.headers ? options.headers : [])
    });
    axiosPromise.then(function (response) {
        http_debugger_1.httpDebugger.debugResolveHttpRequest();
...
/***/ "../core/_commonjs/http/http.models.js":
/*!*********************************************!*\
  !*** ../core/_commonjs/http/http.models.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/http/http.service.js":
/*!**********************************************!*\
  !*** ../core/_commonjs/http/http.service.js ***!
  \**********************************************/
/*! no static exports found */
...
var HttpFunctions = __webpack_require__(/*! ./http.functions */ "../core/_commonjs/http/http.functions.js");
var retry_strategy_1 = __webpack_require__(/*! ./retry-strategy */ "../core/_commonjs/http/retry-strategy.js");
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.mapAxiosObservable = function (axiosObservable, call, options) {
        var _this = this;
        return axiosObservable(call, options).pipe(operators_1.retryWhen(retry_strategy_1.retryStrategy.strategy({
            ...
            if (options && options.logErrorToConsole) {
                console.warn("Kentico Cloud SDK encountered an error posting data: ", error);
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./retry-strategy */ "../core/_commonjs/http/retry-strategy.js"));
__export(__webpack_require__(/*! ./http.service */ "../core/_commonjs/http/http.service.js"));
__export(__webpack_require__(/*! ./http.models */ "../core/_commonjs/http/http.models.js"));
__export(__webpack_require__(/*! ./http.functions */ "../core/_commonjs/http/http.functions.js"));
__export(__webpack_require__(/*! ./http.debugger */ "../core/_commonjs/http/http.debugger.js"));
__export(__webpack_require__(/*! ./test-http.service */ "../core/_commonjs/http/test-http.service.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../core/_commonjs/http/retry-strategy.js":
/*!************************************************!*\
  !*** ../core/_commonjs/http/retry-strategy.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "../core/_commonjs/http/test-http.service.js":
/*!***************************************************!*\
  !*** ../core/_commonjs/http/test-http.service.js ***!
  \***************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
/* Public API */
__export(__webpack_require__(/*! ./helpers */ "../core/_commonjs/helpers/index.js"));
__export(__webpack_require__(/*! ./models */ "../core/_commonjs/models/index.js"));
__export(__webpack_require__(/*! ./http */ "../core/_commonjs/http/index.js"));
__export(__webpack_require__(/*! ./error-handling */ "../core/_commonjs/error-handling/index.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../core/_commonjs/models/index.js":
/*!*****************************************!*\
  !*** ../core/_commonjs/models/index.js ***!
  \*****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./parameters */ "../core/_commonjs/models/parameters.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../core/_commonjs/models/parameters.js":
/*!**********************************************!*\
  !*** ../core/_commonjs/models/parameters.js ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./lib/axios */ "../core/node_modules/axios/lib/axios.js");
...
var utils = __webpack_require__(/*! ./../utils */ "../core/node_modules/axios/lib/utils.js");
var settle = __webpack_require__(/*! ./../core/settle */ "../core/node_modules/axios/lib/core/settle.js");
var buildURL = __webpack_require__(/*! ./../helpers/buildURL */ "../core/node_modules/axios/lib/helpers/buildURL.js");
var parseHeaders = __webpack_require__(/*! ./../helpers/parseHeaders */ "../core/node_modules/axios/lib/helpers/parseHeaders.js");
var isURLSameOrigin = __webpack_require__(/*! ./../helpers/isURLSameOrigin */ "../core/node_modules/axios/lib/helpers/isURLSameOrigin.js");
var createError = __webpack_require__(/*! ../core/createError */ "../core/node_modules/axios/lib/core/createError.js");
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(/*! ./../helpers/btoa */ "../core/node_modules/axios/lib/helpers/btoa.js");
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(/*! ./../helpers/cookies */ "../core/node_modules/axios/lib/helpers/cookies.js");
...
var utils = __webpack_require__(/*! ./utils */ "../core/node_modules/axios/lib/utils.js");
var bind = __webpack_require__(/*! ./helpers/bind */ "../core/node_modules/axios/lib/helpers/bind.js");
var Axios = __webpack_require__(/*! ./core/Axios */ "../core/node_modules/axios/lib/core/Axios.js");
var defaults = __webpack_require__(/*! ./defaults */ "../core/node_modules/axios/lib/defaults.js");
...
axios.Cancel = __webpack_require__(/*! ./cancel/Cancel */ "../core/node_modules/axios/lib/cancel/Cancel.js");
axios.CancelToken = __webpack_require__(/*! ./cancel/CancelToken */ "../core/node_modules/axios/lib/cancel/CancelToken.js");
axios.isCancel = __webpack_require__(/*! ./cancel/isCancel */ "../core/node_modules/axios/lib/cancel/isCancel.js");

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(/*! ./helpers/spread */ "../core/node_modules/axios/lib/helpers/spread.js");
...
var Cancel = __webpack_require__(/*! ./Cancel */ "../core/node_modules/axios/lib/cancel/Cancel.js");
...
var defaults = __webpack_require__(/*! ./../defaults */ "../core/node_modules/axios/lib/defaults.js");
var utils = __webpack_require__(/*! ./../utils */ "../core/node_modules/axios/lib/utils.js");
var InterceptorManager = __webpack_require__(/*! ./InterceptorManager */ "../core/node_modules/axios/lib/core/InterceptorManager.js");
var dispatchRequest = __webpack_require__(/*! ./dispatchRequest */ "../core/node_modules/axios/lib/core/dispatchRequest.js");
...
var enhanceError = __webpack_require__(/*! ./enhanceError */ "../core/node_modules/axios/lib/core/enhanceError.js");
...
var utils = __webpack_require__(/*! ./../utils */ "../core/node_modules/axios/lib/utils.js");
var transformData = __webpack_require__(/*! ./transformData */ "../core/node_modules/axios/lib/core/transformData.js");
var isCancel = __webpack_require__(/*! ../cancel/isCancel */ "../core/node_modules/axios/lib/cancel/isCancel.js");
var defaults = __webpack_require__(/*! ../defaults */ "../core/node_modules/axios/lib/defaults.js");
var isAbsoluteURL = __webpack_require__(/*! ./../helpers/isAbsoluteURL */ "../core/node_modules/axios/lib/helpers/isAbsoluteURL.js");
var combineURLs = __webpack_require__(/*! ./../helpers/combineURLs */ "../core/node_modules/axios/lib/helpers/combineURLs.js");
...
var createError = __webpack_require__(/*! ./createError */ "../core/node_modules/axios/lib/core/createError.js");
...
var utils = __webpack_require__(/*! ./utils */ "../core/node_modules/axios/lib/utils.js");
var normalizeHeaderName = __webpack_require__(/*! ./helpers/normalizeHeaderName */ "../core/node_modules/axios/lib/helpers/normalizeHeaderName.js");
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(/*! ./adapters/xhr */ "../core/node_modules/axios/lib/adapters/xhr.js");
  } else if (typeof process !== 'undefined') {
    // For node use HTTP adapter
    adapter = __webpack_require__(/*! ./adapters/http */ "../core/node_modules/axios/lib/adapters/xhr.js");
  }
  return adapter;
}
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../delivery/node_modules/process/browser.js */ "./node_modules/process/browser.js")))
...
/***/ "../core/node_modules/axios/lib/helpers/btoa.js":
/*!******************************************************!*\
  !*** ../core/node_modules/axios/lib/helpers/btoa.js ***!
  \******************************************************/
/*! no static exports found */
...
var bind = __webpack_require__(/*! ./helpers/bind */ "../core/node_modules/axios/lib/helpers/bind.js");
var isBuffer = __webpack_require__(/*! is-buffer */ "../core/node_modules/is-buffer/index.js");
...
/***/ "../core/node_modules/is-buffer/index.js":
/*!***********************************************!*\
  !*** ../core/node_modules/is-buffer/index.js ***!
  \***********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var kentico_cloud_core_1 = __webpack_require__(/*! kentico-cloud-core */ "../core/_commonjs/index.js");
...
var DeliveryClient = /** @class */ (function () {
    ...
    function DeliveryClient(config) {
        ...
        this.queryService = new services_1.QueryService(config, config.httpService ? config.httpService : new kentico_cloud_core_1.HttpService(), parser_adapter_1.getParserAdapter(), {
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./modular-item-type.enum */ "./lib/enums/modular-item-type.enum.ts"));


/***/ }),

/***/ "./lib/enums/modular-item-type.enum.ts":
/*!*********************************************!*\
  !*** ./lib/enums/modular-item-type.enum.ts ***!
  \*********************************************/
/*! no static exports found */
...
(function (RichTextContentType) {
    RichTextContentType["Item"] = "item";
})(RichTextContentType = exports.RichTextContentType || (exports.RichTextContentType = {}));
...
(function (Fields) {
    ...
    var RichTextField = /** @class */ (function () {
        ...
        */
        function RichTextField(name, value, linkedItemCodenames, data) {
            this.name = name;
            this.value = value;
    ...
    var CustomField = /** @class */ (function () {
        ...
        */
        function CustomField(name, value) {
            ...
            * Type of the field
            */
            this.type = field_type_1.FieldType.Custom;
        }
        return CustomField;
    }());
...
/* enums */
__export(__webpack_require__(/*! ./enums */ "./lib/enums/index.ts"));
...
var FieldMapper = /** @class */ (function () {
    ...
    FieldMapper.prototype.mapField = function (field, modularContent, item, queryConfig, processedItems) {
        var fieldType = kentico_cloud_core_1.enumHelper.getEnumFromValue(fields_1.FieldType, field.type);
        if (fieldType) {
            if (fieldType === fields_1.FieldType.ModularContent) {
                return this.mapLinkedItemsField(field, modularContent, queryConfig, processedItems);
            }
            if (fieldType === fields_1.FieldType.Text) {
                return this.mapTextField(field);
            }
            if (fieldType === fields_1.FieldType.Asset) {
                return this.mapAssetsField(field);
            }
            if (fieldType === fields_1.FieldType.Number) {
                return this.mapNumberField(field);
            }
            if (fieldType === fields_1.FieldType.MultipleChoice) {
                return this.mapMultipleChoiceField(field);
            }
            if (fieldType === fields_1.FieldType.DateTime) {
                return this.mapDateTimeField(field);
            }
            if (fieldType === fields_1.FieldType.RichText) {
                return this.mapRichTextField(field, modularContent, queryConfig, processedItems);
            }
            if (fieldType === fields_1.FieldType.UrlSlug) {
                return this.mapUrlSlugField(field, item, queryConfig);
            }
            if (fieldType === fields_1.FieldType.Taxonomy) {
                return this.mapTaxonomyField(field);
            }
            if (fieldType === fields_1.FieldType.Custom) {
    ...
    FieldMapper.prototype.mapRichTextField = function (field, modularContent, queryConfig, processedItems) {
        ...
        if (field.modular_content) {
            if (Array.isArray(field.modular_content)) {
                field.modular_content.forEach(function (codename) {
                    ...
                    var existingLinkedItem = _this.getOrSaveLinkedItem(codename, field, queryConfig, modularContent, processedItems);
                    if (existingLinkedItem) {
                        ...
                        if (rawItem) {
                            var mappedLinkedItem = _this.mapFields(rawItem, modularContent, queryConfig, processedItems);
        ...
        return new fields_1.Fields.RichTextField(field.name, field.value, field.modular_content, {
            links: links,
            resolveHtml: function () { return resolvers_1.richTextResolver.resolveHtml(field.value, {
                ...
                getLinkedItem: function (codename) { return _this.getOrSaveLinkedItem(codename, field, queryConfig, modularContent, linkedItems); },
                links: links,
    ...
    FieldMapper.prototype.mapCustomField = function (field, contentType) {
        // try to find field resolver
        if (this.config.fieldResolver) {
            var customModel = this.config.fieldResolver(contentType, field.name, field.value);
            if (customModel) {
                return customModel;
            }
        }
        return new fields_1.Fields.CustomField(field.name, field.value);
    };
    FieldMapper.prototype.mapUrlSlugField = function (field, item, queryConfig) {
        ...
        return new fields_1.Fields.UrlSlugField(field.name, field.value, {
            resolveLink: function () { return resolvers_1.urlSlugResolver.resolveUrl({
    ...
    FieldMapper.prototype.mapLinkedItemsField = function (field, modularContent, queryConfig, processedItems) {
        var _this = this;
        if (!field) {
        ...
        linkedItemCodenames.forEach(function (codename) {
            var linkedItem = _this.getOrSaveLinkedItem(codename, field, queryConfig, modularContent, processedItems);
            if (linkedItem) {
                // add item to result
    ...
    FieldMapper.prototype.getOrSaveLinkedItem = function (codename, field, queryConfig, modularContent, processedItems) {
        // first check if item was already resolved and return it if it was
        var existingItem = processedItems.find(function (m) { return m.system.codename === codename; });
        if (existingItem) {
            return existingItem;
        }
        var rawItem = modularContent[codename];
        ...
        if (queryConfig.itemResolver) {
            var customMappedItem = queryConfig.itemResolver(field, rawItem, modularContent, queryConfig);
            if (customMappedItem) {
...
var ResponseMapper = /** @class */ (function () {
    ...
    ResponseMapper.prototype.mapSingleResponse = function (response, queryConfig) {
        // map item
        var item = this.itemMapper.mapSingleItem(response.data, queryConfig);
    ...
    ResponseMapper.prototype.mapMultipleResponse = function (response, queryConfig) {
        // map items
        var items = this.itemMapper.mapMultipleItems(response.data, queryConfig);
        // pagination
        var pagination = new models_1.Pagination({
            skip: response.data.pagination.skip,
            count: response.data.pagination.count,
    ...
    ResponseMapper.prototype.mapElementResponse = function (response) {
        // map element
        var element = this.elementMapper.mapElement(response.data);
...
(function (ItemResponses) {
    var DeliveryItemListingResponse = /** @class */ (function () {
        ...
        */
        ...
        DeliveryItemListingResponse.prototype.getIsEmpty = function () {
            if (!this.items) {
                return true;
            }
        ...
        DeliveryItemListingResponse.prototype.getLastItem = function () {
            if (!this.items) {
                return;
            }
            if (this.items.length < 1) {
    ...
    var DeliveryItemResponse = /** @class */ (function () {
        ...
        */
        ...
        DeliveryItemResponse.prototype.getIsEmpty = function () {
            if (!this.item) {
                return true;
            }
            return false;
...
var BrowserRichTextParser = /** @class */ (function () {
    function BrowserRichTextParser() {
        this.linkedItemWrapperElem = 'div';
        this.modularContentElementData = {
    ...
    BrowserRichTextParser.prototype.createWrapperElement = function (html) {
        var element = document.createElement(this.linkedItemWrapperElem);
        ...
        if (!htmlCollection || htmlCollection.length === 0) {
            ...
            for (var i = 0; i < htmlCollection.length; i++) {
                ...
                if (element.attributes && typeAttribute && typeAttribute.value && typeAttribute.value.toLowerCase() === this.modularContentElementData.type.toLowerCase()) {
                    ...
                    var dataCodenameAttribute = element.attributes.getNamedItem(this.modularContentElementData.dataCodename);
                    var dataTypeAttribute = element.attributes.getNamedItem(this.modularContentElementData.dataType);
                    ...
                    if (!parentElement) {
                        ...
                        if (dataTypeAttribute.value === 'item') {
                            type = enums_1.RichTextContentType.Item;
                        }
                        else {
                ...
                if (element.nodeName.toLowerCase() === this.link.nodeName.toLowerCase()) {
                    ...
                    if (dataItemIdAttribute) {
                        ...
                        var linkResult = replacement.getLinkResult(link.dataItemId, linkText);
                        var useResultAsUrl = true;
                        ...
                        if (!useResultAsUrl) {
                            ...
                            if (linkResult) {
                                ...
                                var linkHtml = linkResult.asHtml;
                        ...
                        if (useResultAsUrl) {
                            ...
                            if (!hrefAttribute) {
                                ...
                                // get link url
                                var linkUrlResult = typeof linkResult === 'string' ? linkResult : linkResult.asUrl;
...
var Parse5RichTextParser = /** @class */ (function () {
    ...
    Parse5RichTextParser.prototype.resolveRichTextField = function (html, replacement, config) {
        try {
            // create document
    ...
    Parse5RichTextParser.prototype.processRichTextField = function (elements, replacement, config, result) {
        var _this = this;
    ...
    Parse5RichTextParser.prototype.processLink = function (element, replacement, config, result) {
        ...
        var linkResult = replacement.getLinkResult(link.dataItemId, originalLinkText || '');
        var useResultAsUrl = true;
        if (typeof linkResult === 'string') {
            // use result as URL
            useResultAsUrl = true;
        ...
        if (!useResultAsUrl) {
            ...
            if (linkResult) {
                // html for link is defined
                var linkHtml = linkResult.asHtml ? linkResult.asHtml : '';
                if (linkHtml) {
    ...
    Parse5RichTextParser.prototype.processModularContent = function (element, replacement, config, result) {
        var _this = this;
        var attributes = element.attrs;
        var typeAttribute = attributes.find(function (m) { return m.value === _this.modularContentElementData.type; });
        if (!typeAttribute) {
            // node is not kentico cloud data type
            return;
        }
        var dataTypeAttribute = attributes.find(function (m) { return m.name === _this.modularContentElementData.dataType; });
        if (!dataTypeAttribute) {
        ...
        var dataCodenameAttribute = attributes.find(function (m) { return m.name === _this.modularContentElementData.dataCodename; });
        ...
        // get html
        var resultHtml = replacement.getLinkedItemHtml(itemCodename, type);
...
var MultipleItemQuery = /** @class */ (function (_super) {
     ...
     * @param field Element by which to order
     */
    MultipleItemQuery.prototype.orderByDescending = function (field) {
        this.parameters.push(new models_1.Parameters.OrderParameter(field, models_1.SortOrder.desc));
        return this;
    };
    /**
   ...
   * @param field Element by which to order
   */
    MultipleItemQuery.prototype.orderByAscending = function (field) {
        this.parameters.push(new models_1.Parameters.OrderParameter(field, models_1.SortOrder.asc));
        return this;
    };
    /**
...
var RichTextResolver = /** @class */ (function () {
    ...
    RichTextResolver.prototype.resolveHtml = function (html, data) {
        ...
        var result = data.richTextHtmlParser.resolveRichTextField(html, {
            getLinkResult: function (itemId, linkText) { return _this.getLinkResult({
                config: config,
                links: data.links,
                itemId: itemId,
            ...
            getLinkedItemHtml: function (itemCodename, itemType) { return _this.getLinkedItemHtml({
    ...
    RichTextResolver.prototype.getLinkResult = function (data) {
...
var StronglyTypedResolver = /** @class */ (function () {
     ...
     */
    StronglyTypedResolver.prototype.mapSystemAttributes = function (rawSystem) {
        return new content_item_system_attributes_1.ContentItemSystemAttributes({
            name: rawSystem.name,
    ...
    UrlSlugResolver.prototype.resolveUrl = function (data) {
        if (!data.linkResolver) {
            if (data.enableAdvancedLogging) {
                console.warn("You have to implement 'linkResolver' in your Model class or your query in order to get url of this item. This warning can be turned off by disabling 'enableAdvancedLogging' option.");
            }
            return undefined;
        }
        if (!data.item) {
            if (data.enableAdvancedLogging) {
                console.warn("Cannot resolve link for field '" + data.fieldName + "' because no item was provided to URL slug field (item may be missing from response). This warning can be turned off by disabling 'enableAdvancedLogging' option.");
            }
            return undefined;
        }
        ...
        if (!url) {
            if (data.enableAdvancedLogging) {
                console.warn("'linkResolver' is configured, but url resolved for '" + data.item.system.codename + "' item of '" + data.item.system.type + "' type inside '" + data.fieldName + "' field resolved to an undefined url. This warning can be turned off by disabling 'enableAdvancedLogging' option.");
            }
            return undefined;
        }
        return url;
...
var BaseDeliveryQueryService = /** @class */ (function () {
    ...
    sdkInfo) {
      ...
      */
         ...
         */
        this.useRetryForResponseCodes = [500];
        /**
         * Header name for SDK usage
         */
        this.sdkVersionHeader = 'X-KC-SDKID';
 ...
 */
   ...
   */
     ...
     * @param queryConfig Query configuration
     */
    BaseDeliveryQueryService.prototype.getDeliveryUrl = function (queryConfig) {
        if (this.isPreviewModeEnabled(queryConfig)) {
...
var QueryService = /** @class */ (function (_super) {
    ...
    function QueryService(config, httpService, richTextHtmlParser, sdkInfo) {
        return _super.call(this, config, httpService, richTextHtmlParser, sdkInfo) || this;
    }
    /**
